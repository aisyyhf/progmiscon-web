...
export const uiText = {
  ...
  homeReviewAssessment: { id: "Masuk Dosen", en: "Lecturer Login" },
  ...
  checkedElements: { id: "Elemen yang Diperiksa", en: "Checked Elements" },
  ...
  expectedConcepts: { id: "Konsep yang Diharapkan", en: "Expected Concepts" },
  masteredConcepts: { id: "Konsep yang Dikuasai", en: "Mastered Concepts" },
  ...
  selectAnswerCase: { id: "Pilih case jawaban", en: "Select answer case" },

  answerStatus: { id: "Status Jawaban", en: "Answer Status" },
  studentAnswerLabel: { id: "Jawaban Anonim", en: "Anonymous Answer" },
  anonymousAnswerLabel: { id: "Jawaban Anonim", en: "Anonymous Answer" },
