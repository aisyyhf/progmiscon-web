    ...
    <li>
      ...
      >
        ...
        {typeof misconceptionCount === "number" && (
          <span className="shrink-0 whitespace-nowrap rounded-full border border-gold/30 bg-gold-soft/35 px-2.5 py-1 text-[11px] text-navy-deep">
