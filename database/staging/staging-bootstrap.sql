...
CREATE OR REPLACE FUNCTION "public"."reset_question_reviews_v3"("p_question_id" "text", "p_source_version" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."reset_question_reviews_v3"("p_question_id" "text", "p_source_version" "uuid") OWNER TO "postgres";
...
revoke all on function public.reset_question_reviews_v3(text, uuid) from public, anon, authenticated, service_role;
grant execute on function public.reset_question_reviews_v3(text, uuid) to authenticated;
